...
export class DelayComponent implements OnInit {
  ...
  viewDetialsTitle: string = 'Delay Details';
  ...
  ngOnInit(): void {
    //console.log('🚢 Delay Component Initializing...');
  ...
  handleSubmit(data: any) {
    ...
    this.apiService.post(`master/propulsion/`, this.newDetails).subscribe({
      next: (data: any) => {
        ...
        this.newDetails = {name:'',active:0}
        this.toastService.showSuccess('Propulsion saved successfully'); // ✅ Toast on success
  ...
  deleteDeptDetails(dept: any): void {
    ...
    //console.log("checking delete",this.selectedDetails);
  }
  ...
  cols = [
    ...
    { field: 'name', header: 'Delay Name', filterType: 'text' },
