...
export class RefitComponent implements OnInit {
  ...
  viewDetialsTitle: string = 'Refit Details';
  ...
  ngOnInit(): void {
    //console.log('🚢 Refit Component Initializing...');
  ...
  handleSubmit(data: any) {
    ...
    this.apiService.post(`master/refit/`, this.newDetails).subscribe({
      next: (data: any) => {
        //console.log(data);
  ...
  confirmDeletion() {
    this.apiService
      .delete(`master/refit/${this.selectedDetails.id}/`)
      .subscribe({
        next: (data: any) => {
          //console.log(data);
  ...
  handleEditSubmit(data: any) {
    ...
    this.apiService
      .put(`master/refit/${this.selectedDetails.id}/`, this.selectedDetails)
      .subscribe({
        next: (data: any) => {
          //console.log(data);
          this.toastService.showSuccess('Refit Updated Successfully');
  ...
  cols = [
    ...
    { field: 'name', header: 'Refit Name', filterType: 'text' },
