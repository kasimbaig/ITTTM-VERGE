...
export class RepairAgencyComponent implements OnInit {
  title: string = 'Add new Repair Agency';
  ...
  ngOnInit(): void {
    //console.log('🚢 Repair Agency Component Initializing...');
  ...
  cols = [
    ...
    { field: 'name', header: 'Repair Agency Name', filterType: 'text' },
